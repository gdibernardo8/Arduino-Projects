...
#define DHTBOX_PIN 7                 // Digital pin connected to the DHT sensor (box)
#define DHTENV_PIN 8                 // Digital pin connected to the DHT sensor (enviroment
#define DHTTYPE DHT11                // DHT 11
#define POWER_PIN 10                 // Signal Pin of Relay for power
#define HOTCOLD_PIN 10               // Signal Pin of Relay for heather/cooler (polarization)
